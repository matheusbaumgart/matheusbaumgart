...
export default class PrivacyToday extends Component {
  render() {
    return (
      <div className="main-col">
        <h2 style={{ marginBottom: 20 }}>Today - Digital Agenda</h2>
        <h4>Privacy Policy</h4>
        <p>
          Matheus Baumgart built the Today app as a Free app. This SERVICE is
          provided by Matheus Baumgart at no cost and is intended for use as is.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at Today unless otherwise
        ...
        <p>
          ...
          <a className="link-underline" href="mailto:matheusbaumgart@gmail.com">
            matheusbaumgart@gmail.com
          </a>
        </p>
      </div>
    );
